...
param (
    ...
    [Parameter(Mandatory = $false)][bool]$ppD365SalesApp,
    [Parameter(Mandatory = $false)][bool]$ppD365CustomerServiceApp,
    [Parameter(Mandatory = $false)][bool]$ppD365FieldServiceApp        
)
